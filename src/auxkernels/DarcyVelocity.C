...
DarcyVelocity::validParams()
{
  ...
  // Required parameter for specifying the MooseVariable to couple to, i.e.,
  // pressure
...
DarcyVelocity::DarcyVelocity(const InputParameters & parameters)
  : VectorAuxKernel(parameters),
    ...
    // Note that only AuxKernels operating on elemental AuxVariables can
    // consume a MaterialProperty reference, since they are defined at the
    // Gauss QPs within the element
